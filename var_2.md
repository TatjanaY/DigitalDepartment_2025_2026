...
Слушатель должен применить методы **линейного программирования** и решить задачу с использованием `scipy.optimize.linprog`.
...
Слушателю необходимо построить несколько графиков, чтобы полноценно проанализировать результат:
